...
library(data.table)
ad=fread('/Genomics/ayroleslab2/scott/git/chromium/data/snakemake_tmp/count_info/joint_call_4.AD.filt.txt')
dp=fread('/Genomics/ayroleslab2/scott/git/chromium/data/snakemake_tmp/count_info/joint_call_4.DP.filt.txt')
